            ...
            children: [
              ...
              Container(
                ...
                child: TextField(
                  ...
                  style: GoogleFonts.inter(
                      fontSize: 13.5, color: _C.textPrimary),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    _roleBadge(UserRole.superAdmin,
                        allUsers.where((u) => u.role == UserRole.superAdmin).length),
                    const SizedBox(width: 8),
                    _roleBadge(UserRole.admin,
                        allUsers.where((u) => u.role == UserRole.admin).length),
                    const SizedBox(width: 8),
                    _roleBadge(UserRole.user,
                        ...
                        child: Row(
                          children: [
                            Icon(
                              ...
                              size: 20,
                              color:
                                  selected == role ? role.color : _C.textHint,
                            ),
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          FilledButton(
            style: FilledButton.styleFrom(
              backgroundColor:
                  user.isSuspended ? _C.success : _C.error,
              foregroundColor: _C.white,
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(12),
              ),

                          ...
                          if (origin.isNotEmpty && destination.isNotEmpty) ...[
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                const Icon(Iconsax.routing_2, size: 14, color: _C.textSecondary),
                                ...
                                Padding(
                                  ...
                                  child: Icon(Iconsax.arrow_right_1, size: 12, color: _C.textTertiary),
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // ── Driver list — Real-time StreamBuilder nested in FutureBuilder ──

              Flexible(

                child: FutureBuilder<QuerySnapshot>(

                  future: FirebaseFirestore.instance.collection('fleets').get(),

                  builder: (ctx, fleetSnapshot) {

                    final Map<String, String> driverAssignments = {};

                    if (fleetSnapshot.hasData) {

                      for (final doc in fleetSnapshot.data!.docs) {

                        final d = doc.data() as Map<String, dynamic>;

                        final dId = d['driverId'] as String? ?? '';

                        final fName = d['name'] as String? ?? '';

                        final fRoute = (d['origin'] != null && d['destination'] != null)

                            ? '${d['origin']} → ${d['destination']}'

                            : '';

                        final fTime = (d['departureTimes'] as List?)?.isNotEmpty == true

                            ? (d['departureTimes'] as List).first

                            : '';

                        if (dId.isNotEmpty) {

                          driverAssignments[dId] = "$fName ($fRoute • $fTime)";
                      ...
                      builder: (ctx, snapshot) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (ctx, i) {
                            ...
                            final String? assignedFleet = driverAssignments[driverUid];

                            final bool isAssigned = assignedFleet != null && !isCurrentDriver;

                            // Inisial untuk CircleAvatar

                            final String initials = driverName.isNotEmpty ? driverName[0].toUpperCase() : '?';
                            ...
                            return Padding(
                              ...
                              child: Material(
                                ...
                                color: isCurrentDriver ? _C.primary.withValues(alpha: 0.06) : Colors.transparent,
                                                ...
                                                ..showSnackBar(
                                                  ...
                                                  SnackBar(
                                                    ...
                                                    content: Text(
                                                      ...
                                                      'Supir ini sedang ditugaskan di ' + assignedFleet + '. Bebaskan supir dari armada tersebut sebelum menugaskannya di sini.',

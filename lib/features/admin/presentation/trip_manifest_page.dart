...
class _TripManifestPageState extends State<TripManifestPage> {
  ...
  void _onPassengerValidated(String ticketCode, String passengerName, int seatNumber) {
    setState(() {
              ...
              SliverPadding(
                ...
                sliver: SliverList(
                  delegate: SliverChildBuilderDelegate(
                    (context, index) => _buildPassengerTile(
                      _trip.passengers[index],
                      index,
                    ),
  ...
  Widget _buildRouteCard(bool isSmall) {
    ...
    final date = DateFormat('EEEE, dd MMM yyyy', 'id_ID').format(_trip.departureTime);
  ...
  Widget _buildStatusActions() {
    return Row(
      children: [
        ...
        if (_trip.status == TripStatus.selesai || _trip.status == TripStatus.dibatalkan)
          Expanded(
            child: Container(
  ...
  Widget _buildSeatTile(_SeatType type, double size) {
      ...
      return SizedBox(
        ...
        child: Center(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(Iconsax.arrow_down, size: 12, color: _C.textHint.withValues(alpha: 0.5)),
    ...
    return GestureDetector(
      onTap: passenger != null
          ? () => _showPassengerDetail(passenger)
          : null,
  ...
  Widget _buildScanFAB() {
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                const Icon(Iconsax.scan_barcode, size: 20, color: Colors.white),
        ...
        .slideY(begin: 0.3, delay: 600.ms, duration: 400.ms, curve: Curves.easeOutBack);
  }
}
